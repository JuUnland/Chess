...
{
    SDL_Texture* text_rook = m_handler->loadImage("Bilder\\Chess_rlt60.png");
    SDL_Texture* text_knight = m_handler->loadImage("Bilder\\Chess_nlt60.png");
    SDL_Texture* text_bishop = m_handler->loadImage("Bilder\\Chess_blt60.png");
    SDL_Texture* text_queen = m_handler->loadImage("Bilder\\Chess_qlt60.png");
    int y_draw = 0;
    Piece::Team team = Piece::WHITE;

    if (m_field[xStart][yStart]->getTeam() == Piece::BLACK)
    {
        text_rook = m_handler->loadImage("Bilder\\Chess_rdt60.png");
        text_knight = m_handler->loadImage("Bilder\\Chess_ndt60.png");
        text_bishop = m_handler->loadImage("Bilder\\Chess_bdt60.png");
        text_queen = m_handler->loadImage("Bilder\\Chess_qdt60.png");
